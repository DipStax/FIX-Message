...
namespace fix::tag
{
    ...
    constexpr const char ResetSeqNumFlag[] = "141";         ///< Tag [141](https://www.onixs.biz/fix-dictionary/4.2/tagNum_141.html).
    ...
    constexpr const char RefMsgType[] = "372";              ///< Tag [372](https://www.onixs.biz/fix-dictionary/4.2/372.html).
    constexpr const char SessionRejectReason[] = "373";     ///< Tag [373](https://www.onixs.biz/fix-dictionary/4.2/tagNum_373.html).
    constexpr const char NoMsgTypes[] = "384";              ///< Tag [384](https://www.onixs.biz/fix-dictionary/4.2/tagNum_384.html).
    constexpr const char MsgDirection[] = "385";            ///< Tag [385](https://www.onixs.biz/fix-dictionary/4.2/tagNum_385.html).
}